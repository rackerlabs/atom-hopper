 ...
 * </ul>
 *
 * The actual insertion into the database is to be handled by the 2 following abstract methods
 *
 * <ul>
 *     <li>insertDb(...)</li>
 *     <li>insertDbOverrideDate(...)</li>
 * </ul>
 *
 *
 * See the JdbcFeedPublisher class for a sample implementation
 */
public abstract class AbstractJdbcFeedPublisher implements FeedPublisher {
    ...
    protected abstract void insertDb( PersistedEntry persistedEntry );

    protected abstract void insertDbOverrideDate( PersistedEntry persistedEntry );
