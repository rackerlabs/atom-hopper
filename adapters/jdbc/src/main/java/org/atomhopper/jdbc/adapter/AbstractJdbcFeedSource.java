 ...
 * </ul>
 *
 * The only implementation required is the org.springframework.jdbc.core.RowMapper implementation, which is exposed
 * through the following abstract method:
 *
 * <ul>
 *     <li>getRowMapper(...)</li>
 * </ul>
 *
 * The SearchToSqlConverter can be configured by overriding the getSearchToSqlConverter() method.  See the
 * SearchToSqlConverter class for information on how to map specific category prefixes to postgres columns within the
 * db.
 *
 * See the JdbcFeedSource class for a sample implementation.
 *
 */
public abstract class AbstractJdbcFeedSource implements FeedSource {

    static Logger LOG = LoggerFactory.getLogger(
          AbstractJdbcFeedSource.class );
    ...
    protected SearchToSqlConverter getSearchToSqlConverter() {
        ...
        // returning new object to be thread-safe
        return new SearchToSqlConverter();
    }
